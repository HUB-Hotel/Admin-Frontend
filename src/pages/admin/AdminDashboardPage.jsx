...
const AdminDashboardPage = () => {
  ...
  const dashboardCards = [
    ...
    },
    {
      ...
      stats: [
        { label: "사이트 설정", value: "관리", path: "/business/settings?tab=site" },
        { label: "운영 정책", value: "설정", path: "/business/settings?tab=policy" },
        { label: "보안 설정", value: "관리", path: "/business/settings?tab=security" },
        { label: "알림 설정", value: "설정", path: "/business/settings?tab=notifications" },
      ],
      color: "#8B5CF6",
    },
    {
