...
const AdminSidebar = () => {
  ...
  const menuItems = [
    ...
    { path: "/admin/hotels", label: "호텔 관리", icon: <HotelIcon /> },
    { path: "/admin/users", label: "회원 관리", icon: <UserIcon /> },
    { path: "/admin/reviews", label: "리뷰 관리", icon: <ReviewIcon /> },
    { path: "/admin/coupons", label: "쿠폰 관리", icon: <CouponIcon /> },
    { path: "/admin/revenue", label: "매출 관리", icon: <RevenueIcon /> },
    { path: "/admin/settings", label: "설정", icon: <SettingsIcon /> },
    { path: "/admin/me", label: "내 정보", icon: <ProfileIcon /> },
  ];
